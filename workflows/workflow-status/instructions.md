...
<critical>You MUST have already loaded and processed: {project-root}/.harmony/workflows/workflow-status/workflow.yaml</critical>
...
<check if="no status file found">
  ...
  <check if="response == y OR response == yes">
    ...
    <invoke-workflow path="{project-root}/.harmony/workflows/workflow-status/init/workflow.yaml"></invoke-workflow>
