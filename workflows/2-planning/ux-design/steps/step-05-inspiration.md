...
- Execute {project-root}/.harmony/core/tasks/advanced-elicitation.xml with the current inspiration analysis content
...
- Execute {project-root}/.harmony/core/workflows/party-mode/workflow.md with the current inspiration analysis
