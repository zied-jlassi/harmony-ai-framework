...
- The `{project_root}/.harmony/core/tasks/validate-workflow.xml` framework will automatically:
...
3. **Load validation framework**: `{project_root}/.harmony/core/tasks/validate-workflow.xml`
