...
<critical>You MUST have already loaded and processed: {project-root}/.harmony/workflows/document-project/workflow.yaml</critical>
...
<invoke-workflow path="{project-root}/.harmony/workflows/workflow-status">
