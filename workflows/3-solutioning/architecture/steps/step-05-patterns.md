...
- Execute {project-root}/.harmony/core/tasks/advanced-elicitation.xml with current patterns
...
- Execute {project-root}/.harmony/core/workflows/party-mode/workflow.md with implementation patterns context
