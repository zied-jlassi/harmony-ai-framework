...
```xml
<critical>The workflow execution engine is governed by: {project_root}/.harmony/core/tasks/workflow.xml</critical>
...
<workflow>
  ...
  <step n="9" goal="Validate Content">
    <invoke-task>Validate against checklist at {{validation}} using {.harmony}/core/tasks/validate-workflow.xml</invoke-task>
  </step>
