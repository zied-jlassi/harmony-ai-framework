...
- Execute {project-root}/.harmony/core/tasks/advanced-elicitation.xml with current scoping analysis
...
- Execute {project-root}/.harmony/core/workflows/party-mode/workflow.md with scoping context
