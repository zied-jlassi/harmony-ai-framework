...
- Agent manifest CSV is available at `{project-root}/.harmony/_cfg/agent-manifest.csv`
...
Load and parse the agent manifest CSV from `{project-root}/.harmony/_cfg/agent-manifest.csv`
...
Welcome {{user_name}}! I'm excited to facilitate an incredible multi-agent discussion with our complete Harmony team. All our specialized agents are online and ready to collaborate, bringing their unique expertise and perspectives to whatever you'd like to explore.
...
"**Agent roster loaded successfully!** All our Harmony experts are excited to collaborate with you.
