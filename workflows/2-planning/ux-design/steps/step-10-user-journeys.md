...
- Execute {project-root}/.harmony/core/tasks/advanced-elicitation.xml with the current user journey content
...
- Execute {project-root}/.harmony/core/workflows/party-mode/workflow.md with the current user journeys
