...
- Execute {project-root}/.harmony/core/tasks/advanced-elicitation.xml with specific decision categories
...
- Execute {project-root}/.harmony/core/workflows/party-mode/workflow.md with architectural decisions context
