...
> **🌐 Langue :** [English](../../architecture/TODO-context-loading.md) · Français
...
## P0 : Context Preloader (CRITIQUE)

### Tâche 1 : `lib/context-preloader.sh`
...
**Dépendances :**
- [ ] Accès à l'API Haiku (via Claude Code ou direct)
- [ ] jq pour le parsing JSON
- [ ] routing-rules.yaml chargé
...
### Tâche 3 : `lib/knowledge-loader.sh`
...
### Tâche 4 : `lib/memory-injector.sh`
...
## P2 : Intégration Guardian

### Tâche 5 : Modifier `agents/guardian.md`

**Ajouter une section après le routage :**
...
Pour la classification Haiku, les options sont :
1. **Intégré à Claude Code** - Utiliser l'outil Task avec le modèle haiku
2. **API directe** - Nécessite ANTHROPIC_API_KEY
3. **Mode mock** - Pour les tests sans API
