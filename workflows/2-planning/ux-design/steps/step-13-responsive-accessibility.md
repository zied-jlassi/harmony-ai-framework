...
- Execute {project-root}/.harmony/core/tasks/advanced-elicitation.xml with the current responsive/accessibility content
...
- Execute {project-root}/.harmony/core/workflows/party-mode/workflow.md with the current responsive/accessibility strategy
