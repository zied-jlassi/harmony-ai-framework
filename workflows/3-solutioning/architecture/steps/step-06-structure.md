...
- Execute {project-root}/.harmony/core/tasks/advanced-elicitation.xml with current project structure
...
- Execute {project-root}/.harmony/core/workflows/party-mode/workflow.md with project structure context
