...
> **🌐 Langue :** [English](../concepts.md) · Français

Comprendre la philosophie et l'architecture derrière Harmony Framework.
...
> **« L'amélioration par les Prompts et la Mémoire, pas par la modification des poids du modèle. »**

Harmony repose sur la conviction que :

1. **Le LLM reste intact** - Pas de fine-tuning requis
2. **L'intelligence émerge de l'architecture** - La structure crée la capacité
3. **La performance est garantie** - Aucune dégradation due aux modifications
4. **L'apprentissage est persistant** - Le savoir survit aux sessions

Cela signifie qu'Harmony fonctionne avec N'IMPORTE QUEL provider LLM (Claude, GPT, Gemini, modèles locaux) sans modification.

---

## Les Trois Piliers

### 1. Protocole Guardian

Le Guardian est le **protecteur du workflow**. Il garantit que le bon agent traite la bonne tâche au bon moment.
...
| Intention | Mots-clés déclencheurs | Agent cible |
|-----------|------------------------|-------------|
...
Le Sentinel est le **gardien de la mémoire**. Il se souvient des erreurs et évite de les répéter.
...
|------|---------------|--------|
| **CLOSED** | Fonctionnement normal | Autoriser toutes les opérations |
| **OPEN** | 3+ échecs détectés | Bloquer les opérations, exiger un diagnostic |
| **HALF-OPEN** | Test de récupération | Autoriser une opération pour tester |
...
HQVF garantit la qualité via des **cas d'usage vérifiables** (UCV).
...
### Structure de définition d'un agent

Chaque agent d'Harmony suit cette structure :
...
|-----------|--------|------|
| **Cœur** | Guardian, Sentinel, Analyst, Architect, Developer, Tester | Workflow de dév essentiel |
| **Spécialistes** | AI Architect, Exploratory QA, UCV Writer, UCV Validator | Capacités avancées |
| **Conformité** | Security, RGPD, Accessibility, Pentest | Réglementaire et qualité |
| **Sous-agents IA** | Riley, Milo, Oscar, Olivia, Grace, Sage | Spécialisation IA/LLM |
...
| Phase | Nom | Rôle | Artefacts clés | Agents |
|-------|-----|------|----------------|--------|
| 1 | Discovery | Comprendre les besoins | Brief | Analyst |
| 2 | Planning | Définir le périmètre | PRD, Roadmap | Analyst, PM |
| 3 | Solutioning | Concevoir la solution | Architecture, Stories, UCVs | Architect, SM, UX, UCV Writer |
| 4 | Implementation | Construire le produit | Code, Tests, Validations | Developer, Tester, Exploratory QA, UCV Validator |
| 5 | Release | Déployer le produit | Déploiement, Monitoring | DevOps, Olivia |
...
- [Agents Guide](../../agents/INDEX.md) - Plongée dans chaque agent
- [Patterns Reference](../../patterns/INDEX.md) - Bibliothèque de design patterns
- [Rules Reference](../../rules/README.md) - Documentation du moteur de règles
- [Commands Reference](../../commands/index.md) - Commandes CLI
