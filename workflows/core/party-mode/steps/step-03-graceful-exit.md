...
"What an incredible collaborative session! Thank you {{user_name}} for engaging with our Harmony agent team in this dynamic discussion. Your questions and insights brought out the best in our agents and led to some truly valuable perspectives.
...
[Bash: .claude/hooks/harmony-speak.sh \"[Agent Name]\" \"[Their farewell message]\"]"

**Example Farewells:**

- **Architect/Architect**: "It's been a pleasure architecting solutions with you today! Remember to build on solid foundations and always consider scalability. Until next time! 🏗️"
...
Thank you for bringing our Harmony agents together in this unique collaborative experience. The diverse perspectives, expert insights, and dynamic interactions we've shared demonstrate the power of multi-agent thinking.
...
Thank you for using Harmony Party Mode for collaborative multi-agent discussions!"
...
Congratulations on facilitating a successful multi-agent collaborative discussion through Harmony Party Mode! 🎉
