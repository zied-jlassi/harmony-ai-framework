...
- Execute {project-root}/.harmony/core/tasks/advanced-elicitation.xml with the current context analysis
...
- Execute {project-root}/.harmony/core/workflows/party-mode/workflow.md with the current project context
