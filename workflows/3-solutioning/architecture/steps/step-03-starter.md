...
- Execute {project-root}/.harmony/core/tasks/advanced-elicitation.xml with current starter analysis
...
- Execute {project-root}/.harmony/core/workflows/party-mode/workflow.md with starter evaluation context
