...
- Execute {project-root}/.harmony/core/tasks/advanced-elicitation.xml with the current FR list
...
- Execute {project-root}/.harmony/core/workflows/party-mode/workflow.md with the current FR list
...
- Load `{project-root}/.harmony/workflows/2-plan-workflows/prd/steps/step-10-nonfunctional.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/.harmony/workflows/2-plan-workflows/prd/steps/step-10-nonfunctional.md` to define non-functional requirements.
