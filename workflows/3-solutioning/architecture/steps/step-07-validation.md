...
- Execute {project-root}/.harmony/core/tasks/advanced-elicitation.xml with validation issues
...
- Execute {project-root}/.harmony/core/workflows/party-mode/workflow.md with validation context
